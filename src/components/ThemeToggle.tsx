...
export function ThemeToggle() {
 ...
 return <button type="button" onClick={toggle} aria-label={dark?'Activer le mode clair':'Activer le mode sombre'} aria-pressed={dark} title={dark?'Mode clair':'Mode sombre'} className="flex h-10 w-10 items-center justify-center rounded-full border bg-[var(--card)] hover:bg-[var(--muted)]">
